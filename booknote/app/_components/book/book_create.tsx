        ...
        <Tabs defaultValue="search" className="w-full">
          ...
          <TabsContent value="search">
            <div className="space-y-4">
              ...
              <div className="flex">
                <ScrollArea className="h-[300px] md:h-[400px] w-1/2 rounded-md border p-4 overflow-y-auto">
                  {isLoading ? (
                ...
                <div className="h-[300px] md:h-[400px] w-1/2 ml-2 rounded-md border overflow-y-auto">
