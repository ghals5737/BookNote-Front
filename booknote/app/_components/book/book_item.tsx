    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-shrink-0">
          <Image
            src={book.image || '/placeholder.svg?height=48&width=48'}
            alt={book.title}
            width={48}
            height={48}
        ...
        <div className="flex-grow min-w-0">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center space-x-1 flex-grow min-w-0">
              <span className="font-semibold truncate flex-grow min-w-0 max-w-full">
                {book.title}
              </span>
              {book.isPinned && <Pin className="w-4 h-4 text-yellow-500 flex-shrink-0" />}
            </div>
          </div>
